const privacySections = [
    ...
    },
    {
        ...
        list: [
            ...
            "Help prevent fraud or to enforce or protect the rights and properties of eTranzact",
            "Protect the personal safety of eTranzact employees and third parties on eTranzact property."
        ]
    },
    {
        id:3,
        ...
        list: [
            "Use encryption to keep your data private while in transit as required by PCI DSS",
            "Safe Browsing by use of secure web protocol, Security Checkup, and 2 Step Verification to help you protect your account",
            "Help prevent fraud or to enforce or protect the rights and properties of eTranzact",
            "Monitoring and periodic reviews including physical security measures, to prevent unauthorized access to our systems"
        ]
    },
    {
        id:4,
    ...
    },
    {
        ...
        list: [
            "Enable us to carry out transactions and provide the services requested by users",
            "Enable us facilitate ease of transactions and services",
            "Allow us to understand how services are being used by you",
    ...
    },
    {
        ...
        list2: [`eTranzact clients or partners have data protection rights and are entitled to the following`,
                `eTranzact clients or partners are entitled to request copies of their personal data. Charges for this service may apply if it will require significant resources to achieve.`,
                `eTranzact clients or partners have the right to request that we delete their personal data, within specific terms such terms are not limited to regulatory requirements, law enforcement agencies, Legal entities or where such action may result in system or services failure.`,
                `eTranzact clients or partners have the right to request that we update any information in our possession that they believe and prove to have been captured incorrectly and update such information should be updated as appropriate.`,
                `eTranzact clients or partners are at liberty to request that we limit the processing of their personal data, within specific terms such terms are not limited to regulatory requirements, law enforcement agencies, Legal entities or where such action may result in system or services failure.`,
                `eTranzact clients or partners are at will to object to eTranzact reusing their personal data, within specific terms such terms are not limited to regulatory requirements, law enforcement agencies, Legal entities or where such action may result in system or services failure`,
                `Should you have any questions about our GDPR/NDPR compliance program, please contact our Data Protection Office via:`,
                ],
        list: [
            "dpo@etranzact.com",
